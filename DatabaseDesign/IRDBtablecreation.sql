...
CREATE TABLE WAR_DEATHS
  ( WarID	      NUMBER(4) NOT NULL,
    ...
    Deaths	    NUMBER,
  CONSTRAINT WAR_DEATHS_PK PRIMARY KEY (WarID, Side),
  CONSTRAINT WARDEATHS_TO_WAR FOREIGN KEY (WarID)
    REFERENCES WAR (WarID),
  CONSTRAINT WARDEATHS_TO_WARPAR FOREIGN KEY (WarID, Side)
    REFERENCES WAR_PARTICIPANTS (WarID, Side)
  );
